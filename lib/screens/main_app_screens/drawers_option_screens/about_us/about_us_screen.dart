        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("We do not provide any financial return in any form whatsoever, including but not limited to financial securities (debt or equity), interest, dividend, profit share, rewards in cash,"
                  " to individuals who contribute on Hrtaa.org.\n"
                  "\nAny contribution on Hrtaa.org, by an individual, should not be construed as an investment in any form whatsoever."
              ),
            ),
          ],
        ),
